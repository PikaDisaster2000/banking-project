...
public class BankProgram {
    ...
    public boolean loadBank() {
        ...
        try {
            ...
            //for (Account accounts : bankAccounts) {
               // splitCustomerNumber = accounts.getAccountNumber();
    ...
    public void showBalance() { //shows the balance of the avalible bank accounts
        System.out.println("Which account do you want to see a balance of? Type their account number in its entirety.");
    ...
    public void withdraw() {
        System.out.println("Which account are you withdrawing from? Please type the account number in its entirety.");
        ...
        for (Account currentAccount : bankAccounts) {
                if (currentAccount.getAccountNumber().equals(accountNumber)) {
                    try{
                        ...
                        currentAccount.adjustBalance(withdrawAmount);
                        System.out.println("Current Balance: " + currentAccount.getBalance());
                        } 
                        catch (Exception e) {
