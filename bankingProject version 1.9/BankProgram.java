...
public class BankProgram {
    ...
    public void createAccount() { //create account
        ...
        switch (createChoice) {
            ...
            String accountNumber = "08-" + branchNumInput + "-" + customerIDString + "-" + accountTypeInput;
            ...
            Account newAccount = new Account(accountNumber, name, address, accountType, currentBalance);
