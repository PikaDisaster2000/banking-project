...
public class Account //self explanatory but its the class called Account
{
    ...
    public void adjustWithdraw (double withdrawAmount) {
    ...
    public void adjustDeposit (double depositAmount) {
        //deposit amount edit.
        this.currentBalance = this.currentBalance + depositAmount;
        System.out.println(depositAmount + " has been deposited for this account.");
        }
    }
